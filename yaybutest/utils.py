...
def build_environment(base_image):
    ...
    commands = [
        "fakeroot fakechroot -s debootstrap --variant=fakechroot --include=python-setuptools,python-dateutil,python-magic,git-core,ubuntu-keyring %(distro)s %(base_image)s",
        ]
